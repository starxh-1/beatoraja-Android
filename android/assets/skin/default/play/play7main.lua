...
local filepath = {
	{name = "Background", path = "background/play.png"},
	{name = "Note", path = "notes/default.png"},
	{name = "Bomb", path = "bomb/bomb.png"},
	{name = "Gauge", path = "gauge/gauge.png"},
	{name = "Judge", path = "judge/judge.png"},
	{name = "Laser", path = "laser/default.png"},
	{name = "Lanecover", path = "lanecover/lanecover1.png"},
}
...
local function main()
	print("Loading play7main...")
	local play_parts
	local status, err = pcall(function() play_parts = require("play_parts") end)

	if not status then
		-- 如果加载失败，提供一个最小化的 mock 以防止脚本崩溃
		play_parts = {
			judge_count_sources = function() return {} end,
			judge_count_destinations = function() return {} end
		}
		print("Warning: play_parts not found, judge counts will be missing")
	end
	...
	skin.source = {
		{id = 0, path = "skin/default/system.png"},
		{id = "bg", path = "skin/default/play/background/play.png"},
		{id = 2, path = "skin/default/playbg.png"},
		{id = 3, path = "skin/default/play/gauge/gauge.png"},
		{id = 4, path = "skin/default/play/judge/judge.png"},
		{id = 5, path = "skin/default/number.png"},
		{id = 6, path = "skin/default/play/laser/default.png"},
		{id = 7, path = "skin/default/play/notes/default.png"},
		{id = 8, path = "skin/default/close.png"},
		{id = 9, path = "skin/default/scoregraph.png"},
		{id = 10, path = "skin/default/play/bomb/bomb.png"},
		{id = 11, path = "skin/default/ready.png"},
		{id = 12, path = "skin/default/play/lanecover/lanecover1.png"},
		{id = 13, path = "skin/default/judgedetail.png"}
	}
	skin.font = {
		{id = 0, path = "skin/default/VL-Gothic-Regular.ttf"}
	}
