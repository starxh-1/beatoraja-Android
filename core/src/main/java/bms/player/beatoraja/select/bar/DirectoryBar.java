...
public abstract class DirectoryBar extends Bar {
	 ...
	 * 子バーのキャッシュ状態
	 */
	protected enum ChildrenLoadState {
		UNLOADED, LOADING, LOADED, LOADED_EMPTY
	}

	/**
	 * 子バーのロード状態
	 */
	protected ChildrenLoadState childrenLoadState = ChildrenLoadState.UNLOADED;

	/**
	 * 子バーのキャッシュ
	 */
	protected Bar[] cachedChildren = null;
	...
	/**
	 * 子バーのキャッシュをクリアします。次回の getChildren() 呼び出し時に再読み込みされます。
	 */
