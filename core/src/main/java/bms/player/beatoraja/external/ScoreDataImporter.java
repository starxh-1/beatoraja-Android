...
public class ScoreDataImporter {
    ...
    public void importFromLR2ScoreDatabase(String path, SongDatabaseAccessor songdb) {
        ...
        try {
            ...
            AndroidBeanListHandler<Map> rh = new AndroidBeanListHandler<>(Map.class);
            List<Map<String, Object>> scores = (List<Map<String, Object>>) (List) qr.query(con, "SELECT * FROM score", rh);
